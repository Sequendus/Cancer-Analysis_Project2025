...
mosaic_subtypes <- ggplot(data = data) +
  geom_mosaic(aes(x = product(er_status, her2_status), fill = her2_status)) + 
  labs(
    title = 'Distribution of HER2 Status by ER Status',
    x = 'ER Status',
    y = 'HER2 Status'
  ) +
  theme_minimal()

ggplotly(mosaic_subtypes)
